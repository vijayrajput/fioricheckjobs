...
sap.ui.define([
	"com/sap/sdc/hcp/bootcamp/checkjob/fioricheckjobs/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/sap/sdc/hcp/bootcamp/checkjob/fioricheckjobs/model/formatter",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator"
], function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
	"use strict";
	return BaseController.extend("com.sap.sdc.hcp.bootcamp.checkjob.fioricheckjobs.controller.Worklist", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		handleUploadResumePopover: function (oEvent) {
			if (!this._oPopoverR) {
				this._oPopoverR = sap.ui.xmlfragment("com.sap.sdc.hcp.bootcamp.checkjob.fioricheckjobs.view.PopoverProfile", this);
